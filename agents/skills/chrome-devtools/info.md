...
node aria-snapshot.js --url https://example.com --output $HOME/.claude/chrome-devtools/snapshots/page.yaml
```
...
node aria-snapshot.js --url https://example.com --output $HOME/.claude/chrome-devtools/snapshots/$SESSION.yaml
```
...
```bash
# Basic screenshot
node screenshot.js --url https://example.com --output $HOME/.claude/chrome-devtools/screenshots/page.png

# Full page
node screenshot.js --url https://example.com --output $HOME/.claude/chrome-devtools/screenshots/page.png --full-page true

# Specific element
node screenshot.js --url https://example.com --selector ".main-content" --output $HOME/.claude/chrome-devtools/screenshots/element.png
```
...
node screenshot.js --url https://example.com --output $HOME/.claude/chrome-devtools/screenshots/page.png --max-size 3

# Disable compression
node screenshot.js --url https://example.com --output $HOME/.claude/chrome-devtools/screenshots/page.png --no-compress
```
...
# Capture and store
node console.js --url https://example.com --duration 10000 > $HOME/.claude/chrome-devtools/logs/$SESSION/console.json
node network.js --url https://example.com > $HOME/.claude/chrome-devtools/logs/$SESSION/network.json
...
node screenshot.js --output $HOME/.claude/skills/chrome-devtools/screenshots/debug.png
