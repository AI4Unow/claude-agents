...
---
name: skill-share
description: Create Claude Code skills and deploy to Slack for team collaboration. Use when you generate skill structure, validate metadata, or implement team distribution.
