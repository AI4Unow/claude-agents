...
cd $HOME/.claude/skills/marketing-dashboard/server
npm run dev

# Terminal 2: Start Vue frontend
cd $HOME/.claude/skills/marketing-dashboard/app
npm run dev
```
...
# Or manually:
node $HOME/.claude/skills/marketing-dashboard/server/index.js
```
